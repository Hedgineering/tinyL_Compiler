...
static int variable() { /* YOUR CODE GOES HERE */
  int reg;
...
static void assign() {
  ...
  int expr_result_reg = expr();
  CodeGen(STORE, id, expr_result_reg, EMPTY_FIELD);
}
...
static inline int next_register() { return regnum++; }
